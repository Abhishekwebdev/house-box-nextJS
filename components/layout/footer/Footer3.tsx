						...
						<div className="row">
							<div className="col-lg-12">
								<div className="footer-top-area">
									<div className="img1">
										<Link href="/"><img src="/assets/img/logo/logo4.png" alt="housebox" /></Link>
									</div>
									<div className="pera">
									...
									<div className="social">
										<ul>
											...
											<li className="m-0"><Link href="/#"><i className="fa-brands fa-youtube" /></Link></li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div className="row">
							<div className="col-lg col-md-6 col-12">
								<div className="footer-content">
									...
									<ul>
										...
										<li><Link href="/sidebar-grid">Why choose us</Link></li>
										<li><Link href="/reviews">Customer reviews</Link></li>
										<li><Link href="/#">Our team</Link></li>
										<li><Link href="/my-profile">Careers &amp; Jobs</Link></li>
									</ul>
								</div>
							</div>
							<div className="col-lg col-md-6 col-12">
							...
							<div className="col-lg col-md-6 col-12">
								<div className="footer-content">
									...
									<ul>
										<li><Link href="/#">#Penthouse for sale</Link></li>
										<li><Link href="/#">#Luxury apartments</Link></li>
										<li><Link href="/#">#Studio apartments</Link></li>
										<li><Link href="/#">#Houses with garden</Link></li>
										<li><Link href="/#">#Eco-friendly homes</Link></li>
									</ul>
								</div>
							</div>
							<div className="col-lg col-md-6 col-12">
							...
							<div className="col-lg-12">
								<div className="copyright">
									...
									<ul>
										...
										<li><Link href="/privacy-policy" className="m-0">Cookie Policy</Link></li>
									</ul>
								</div>
							</div>
						</div>
