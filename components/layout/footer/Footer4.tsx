...
export default function Footer4() {
	return (
		<>
			<div className="footer4-section-area" style={{ backgroundImage: 'url(assets/img/all-images/bg/bg5.png)', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
				<div className="container">
					<div className="row">
						<div className="col-lg-12" data-aos="fade-up" data-aos-duration={1000}>
							<div className="footer-others-section">
								<div className="container">
									<div className="row">
										<div className="col-lg-12">
											<div className="footer-widget-section">
												<div className="img1">
													<img src="/assets/img/all-images/others/others-img6.png" alt="housebox" />
												</div>
												<div className="pera">
													<h3>Download Our App</h3>
													<div className="space8" />
													<p>Discover all you need for purchasing, selling, and <br className="d-lg-block d-none" /> renting property with the new
														<span>HouseBox App!</span></p>
												</div>
												<ul>
													<li><Link href="/#"><img src="/assets/img/elements/elements7.png" alt="housebox" /></Link></li>
													<li><Link href="/#"><img src="/assets/img/elements/elements8.png" alt="housebox" /></Link></li>
													<li><Link href="/#"><img src="/assets/img/elements/elements9.png" alt="housebox" /></Link></li>
												</ul>
											</div>
										</div>
									</div>
						...
						<div className="col-lg-3 col-md-6">
							<div className="footer-logoarea">
								<img src="/assets/img/logo/logo5.png" alt="housebox" />
						...
						<div className="col-lg-3 col-md-6">
							<div className="footer-content2 footer-content">
								<h3>Contact Us</h3>
								<div className="space4" />
								<ul>
									<li><Link href="/tel:#+11234567890"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
									...
									</svg> 421 Allen, Mexico 4233</Link></li>
									<li><Link href="/mailto:houseboxesate.com"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
						...
						<div className="col-lg-3 col-md-6">
							<div className="footer-content">
								...
								<ul>
									...
									<li><Link href="/property-halfmap-grid">Listing</Link></li>
									<li><Link href="/property-halfmap-list">Properties</Link></li>
